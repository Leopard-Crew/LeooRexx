...
# LeooRexx Leopard/PPC build-and-smoke-test helper.
# This script must be run on Mac OS X 10.5.x PowerPC.
...
./rexx -e "say 'LeooRexx build test passed: $BUILD_NAME'"
